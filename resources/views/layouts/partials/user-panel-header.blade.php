<header class="user-panel-header">
    <div class="user-panel-header__inner">
        <div class="user-panel-header__start">
            <button
                type="button"
                class="user-shell__menu-btn d-lg-none"
        ...
        <div class="user-panel-header__actions">
            ...
            <a href="{{ route('home') }}" class="user-panel-header__icon-btn user-panel-header__icon-btn--optional d-none d-sm-inline-flex" title="View website" aria-label="View website">
