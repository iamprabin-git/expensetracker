...
>
    ...
    >
        ...
        <span class="user-notifications__badge hidden" data-notifications-badge aria-hidden="true">0</span>
    </button>
    ...
    <div class="dropdown-menu dropdown-menu-end user-notifications__menu border-0 mt-2 p-0">
        <div class="fb-notif-dropdown__header">
            ...
            <button type="button" class="fb-notif-dropdown__mark-all hidden" data-notifications-mark-all>
                Mark all as read
            </button>
        </div>
