<x-marketing-layout title="Membership expired" narrow>
    <div class="mx-auto w-full max-w-6xl px-4 px-3 w-full">
        <div class="site-auth-card text-center">
            <div class="rounded-circle bg-danger-subtle text-destructive inline-flex items-center justify-center mb-4" style="width:4rem;height:4rem;">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="32" height="32">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                </svg>
            </div>
            <h1 class="text-xl font-semibold tracking-tight font-bold mb-2">Membership expired</h1>
